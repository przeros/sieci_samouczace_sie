...
def park_test(param_fiz, stanp, approximator: Sequential, encoder, epoch, num_of_epochs):
    ...
    for epizod in range(liczba_stanow_poczatkowych):
        ...
        while czy_zatrzymanie == False:
            ...
            R = get_reward(param_fiz, nowystan, czy_kolizja, czy_zatrzymanie, state_stagnation_handler, epoch, num_of_epochs)
...
def park_train():
    ...
    for epoch in epochs:
        ...
        while quit == False:
            ...
            reward = get_reward(global_variables, new_state, is_collision, quit, state_stagnation_handler, epoch, num_of_epochs)

            # Aktualizujemy wartosci Q dla aktualnego stanu i wybranej akcji:
            # ........................................................
            # ........................................................
            # w = w + ...
            deep_nn_approximator = update_model_Q_learning_curriculum(state, new_state, selected_action, reward, deep_nn_approximator, encoder, gamma, epoch, num_of_epochs)
            state = new_state

        # co jakis czas test z wygenerowaniem historii do pliku:
        if epoch % 5 == 0:
            print("epoch %d\n" % epoch)
            park_test(global_variables, init_states, deep_nn_approximator, encoder, epoch, num_of_epochs)
